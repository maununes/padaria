...
appControllers.controller('PadariaController', ['$scope', '$routeParams', '$http', '$location', function ($scope,$routeParams,$http,$location) {
    ...
    switch ($routeParams.controller){
        case "index":
            $scope.actionListarCardapios($routeParams.id);
            $scope.template = "views/padaria-index.html";
            break;
        default :
            $scope.template = "views/padaria-"+$routeParams.controller+"-"+$routeParams.action+".html";
            break;
    }
