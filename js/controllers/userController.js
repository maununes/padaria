...
appControllers.controller('UserController', ['$scope', '$routeParams', '$http', '$location', function ($scope,$routeParams,$http,$location) {
    ...
    switch ($routeParams.controller){
        case "index":
            $scope.actionListarCardapios($routeParams.id);
            $scope.template = "views/user-index.html";
            break;
        default :
            $scope.template = "views/user-"+$routeParams.controller+"-"+$routeParams.action+".html";
            break;
    }
